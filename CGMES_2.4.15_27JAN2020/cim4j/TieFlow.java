...
{
	private BaseClass[] TieFlow_attributes;
	...
	public TieFlow() {
		TieFlow_attributes = new BaseClass[TieFlow_primitive_builder.values().length];
	}

	public void updateAttributeInArray(TieFlow_primitive_builder attrEnum, BaseClass value) {
		try {
			TieFlow_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//TieFlow_ATTR_ENUM attrEnum = TieFlow_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (TieFlow_primitive_builder attrEnum: TieFlow_primitive_builder.values()) {
			BaseClass bc = TieFlow_attributes[attrEnum.ordinal()];
			if (bc != null) {
