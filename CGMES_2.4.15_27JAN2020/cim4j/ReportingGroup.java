...
{
	private BaseClass[] ReportingGroup_attributes;
	...
	public ReportingGroup() {
		ReportingGroup_attributes = new BaseClass[ReportingGroup_primitive_builder.values().length];
	}

	public void updateAttributeInArray(ReportingGroup_primitive_builder attrEnum, BaseClass value) {
		try {
			ReportingGroup_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//ReportingGroup_ATTR_ENUM attrEnum = ReportingGroup_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (ReportingGroup_primitive_builder attrEnum: ReportingGroup_primitive_builder.values()) {
			BaseClass bc = ReportingGroup_attributes[attrEnum.ordinal()];
			if (bc != null) {
