 ...
 */
public class Inductance extends BaseClass {

	private static final Logging LOG = Logging.getLogger(Inductance.class);
	...
	public Inductance(double v) {
		value = v;
		initialized = true;
	}

	public Inductance(java.lang.String s) {
		setValue(s);
	}

	@Override
	public BaseClass construct() {
		return new Inductance();
	}
	...
	private final java.lang.String debugName = "Inductance";
