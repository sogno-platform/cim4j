...
public class NonConformLoadGroup extends LoadGroup {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("EnergyConsumers", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("NonConformLoadSchedules", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
