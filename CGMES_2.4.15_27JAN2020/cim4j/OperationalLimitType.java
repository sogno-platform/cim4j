...
public class OperationalLimitType extends IdentifiedObject
{
	...
	public void updateAttributeInArray(OperationalLimitType_class_attributes_enum attrEnum, BaseClass value) {
		try {
	...
	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			...
			System.out.println("Updated OperationalLimitType, setting " + attrName);
		}
	...
	public void setAttribute(java.lang.String attrName, java.lang.String value) {
		try {
			...
			System.out.println("Updated OperationalLimitType, setting " + attrName  + " to: "  + value);
		}
		catch (IllegalArgumentException iae)
		{
			super.setAttribute(attrName, value);
