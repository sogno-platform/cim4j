...
{
	private BaseClass[] DCTopologicalIsland_attributes;
	...
	public DCTopologicalIsland() {
		DCTopologicalIsland_attributes = new BaseClass[DCTopologicalIsland_primitive_builder.values().length];
	}

	public void updateAttributeInArray(DCTopologicalIsland_primitive_builder attrEnum, BaseClass value) {
		try {
			DCTopologicalIsland_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//DCTopologicalIsland_ATTR_ENUM attrEnum = DCTopologicalIsland_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (DCTopologicalIsland_primitive_builder attrEnum: DCTopologicalIsland_primitive_builder.values()) {
			BaseClass bc = DCTopologicalIsland_attributes[attrEnum.ordinal()];
			if (bc != null) {
