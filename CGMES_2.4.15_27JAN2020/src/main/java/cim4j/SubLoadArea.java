...
public class SubLoadArea extends EnergyArea {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("LoadArea", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("LoadGroups", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
