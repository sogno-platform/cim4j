...
{
	private BaseClass[] MonthDay_attributes;
	...
	public MonthDay() {
		MonthDay_attributes = new BaseClass[MonthDay_primitive_builder.values().length];
	}

	public void updateAttributeInArray(MonthDay_primitive_builder attrEnum, BaseClass value) {
		try {
			MonthDay_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//MonthDay_ATTR_ENUM attrEnum = MonthDay_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (MonthDay_primitive_builder attrEnum: MonthDay_primitive_builder.values()) {
			BaseClass bc = MonthDay_attributes[attrEnum.ordinal()];
			if (bc != null) {
