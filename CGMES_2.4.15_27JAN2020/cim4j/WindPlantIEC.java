...
{
	private BaseClass[] WindPlantIEC_attributes;
	...
	public WindPlantIEC() {
		WindPlantIEC_attributes = new BaseClass[WindPlantIEC_primitive_builder.values().length];
	}

	public void updateAttributeInArray(WindPlantIEC_primitive_builder attrEnum, BaseClass value) {
		try {
			WindPlantIEC_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//WindPlantIEC_ATTR_ENUM attrEnum = WindPlantIEC_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (WindPlantIEC_primitive_builder attrEnum: WindPlantIEC_primitive_builder.values()) {
			BaseClass bc = WindPlantIEC_attributes[attrEnum.ordinal()];
			if (bc != null) {
