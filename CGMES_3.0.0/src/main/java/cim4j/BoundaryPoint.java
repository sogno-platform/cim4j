...
public class BoundaryPoint extends PowerSystemResource {
    ...
    private static final java.lang.String CLASS_NAMESPACE = "http://iec.ch/TC57/CIM100-European#";
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("ConnectivityNode", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("fromEndIsoCode", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("fromEndName", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("fromEndNameTso", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("isDirectCurrent", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("isExcludedFromAreaInterchange", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("toEndIsoCode", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("toEndName", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            profiles.add(CGMESProfile.EQBD);
            map.put("toEndNameTso", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
