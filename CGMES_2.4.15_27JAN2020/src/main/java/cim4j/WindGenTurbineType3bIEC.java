...
public class WindGenTurbineType3bIEC extends WindGenTurbineType3IEC {
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindGenTurbineType3bIEC().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("fducw", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("mwtcwp", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("tg", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("two", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("xs", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
