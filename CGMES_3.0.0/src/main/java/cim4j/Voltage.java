 ...
 */
public class Voltage extends BaseClass {

    private static final Logging LOG = Logging.getLogger(Voltage.class);
    ...
    public Voltage(java.lang.String s) {
        setValue(s);
    }
    ...
    private final java.lang.String debugName = "Voltage";
