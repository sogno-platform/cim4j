...
{
	private BaseClass[] BaseVoltage_attributes;
	...
	public BaseVoltage() {
		BaseVoltage_attributes = new BaseClass[BaseVoltage_primitive_builder.values().length];
	}

	public void updateAttributeInArray(BaseVoltage_primitive_builder attrEnum, BaseClass value) {
		try {
			BaseVoltage_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//BaseVoltage_ATTR_ENUM attrEnum = BaseVoltage_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (BaseVoltage_primitive_builder attrEnum: BaseVoltage_primitive_builder.values()) {
			BaseClass bc = BaseVoltage_attributes[attrEnum.ordinal()];
			if (bc != null) {
