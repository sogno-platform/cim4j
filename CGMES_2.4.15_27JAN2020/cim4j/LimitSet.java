...
{
	private BaseClass[] LimitSet_attributes;
	...
	public LimitSet() {
		LimitSet_attributes = new BaseClass[LimitSet_primitive_builder.values().length];
	}

	public void updateAttributeInArray(LimitSet_primitive_builder attrEnum, BaseClass value) {
		try {
			LimitSet_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//LimitSet_ATTR_ENUM attrEnum = LimitSet_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (LimitSet_primitive_builder attrEnum: LimitSet_primitive_builder.values()) {
			BaseClass bc = LimitSet_attributes[attrEnum.ordinal()];
			if (bc != null) {
