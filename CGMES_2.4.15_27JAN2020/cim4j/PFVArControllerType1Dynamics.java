...
{
	private BaseClass[] PFVArControllerType1Dynamics_attributes;
	...
	public PFVArControllerType1Dynamics() {
		PFVArControllerType1Dynamics_attributes = new BaseClass[PFVArControllerType1Dynamics_primitive_builder.values().length];
	}

	public void updateAttributeInArray(PFVArControllerType1Dynamics_primitive_builder attrEnum, BaseClass value) {
		try {
			PFVArControllerType1Dynamics_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//PFVArControllerType1Dynamics_ATTR_ENUM attrEnum = PFVArControllerType1Dynamics_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (PFVArControllerType1Dynamics_primitive_builder attrEnum: PFVArControllerType1Dynamics_primitive_builder.values()) {
			BaseClass bc = PFVArControllerType1Dynamics_attributes[attrEnum.ordinal()];
			if (bc != null) {
