...
public class PFVArControllerType2Dynamics extends DynamicsFunctionBlock
{
	...
	public void updateAttributeInArray(PFVArControllerType2Dynamics_class_attributes_enum attrEnum, BaseClass value) {
		try {
	...
	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			...
			System.out.println("Updated PFVArControllerType2Dynamics, setting " + attrName);
		}
	...
	public void setAttribute(java.lang.String attrName, java.lang.String value) {
		try {
			...
			System.out.println("Updated PFVArControllerType2Dynamics, setting " + attrName  + " to: "  + value);
		}
		catch (IllegalArgumentException iae)
		{
			super.setAttribute(attrName, value);
