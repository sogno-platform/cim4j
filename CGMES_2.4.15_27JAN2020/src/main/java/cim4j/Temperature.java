...
public class Temperature extends BaseClass {
	...
	private static final Logging LOG = Logging.getLogger(Temperature.class);
	...
	public Temperature(java.lang.String s) {
		setValue(s);
	}
	...
	private final java.lang.String debugName = "Temperature";
