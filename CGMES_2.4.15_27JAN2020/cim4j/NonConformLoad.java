...
{
	private BaseClass[] NonConformLoad_attributes;
	...
	public NonConformLoad() {
		NonConformLoad_attributes = new BaseClass[NonConformLoad_primitive_builder.values().length];
	}

	public void updateAttributeInArray(NonConformLoad_primitive_builder attrEnum, BaseClass value) {
		try {
			NonConformLoad_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//NonConformLoad_ATTR_ENUM attrEnum = NonConformLoad_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (NonConformLoad_primitive_builder attrEnum: NonConformLoad_primitive_builder.values()) {
			BaseClass bc = NonConformLoad_attributes[attrEnum.ordinal()];
			if (bc != null) {
