...
{
	private BaseClass[] EquivalentEquipment_attributes;
	...
	public EquivalentEquipment() {
		EquivalentEquipment_attributes = new BaseClass[EquivalentEquipment_primitive_builder.values().length];
	}

	public void updateAttributeInArray(EquivalentEquipment_primitive_builder attrEnum, BaseClass value) {
		try {
			EquivalentEquipment_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//EquivalentEquipment_ATTR_ENUM attrEnum = EquivalentEquipment_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (EquivalentEquipment_primitive_builder attrEnum: EquivalentEquipment_primitive_builder.values()) {
			BaseClass bc = EquivalentEquipment_attributes[attrEnum.ordinal()];
			if (bc != null) {
