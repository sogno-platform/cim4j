...
public class RatioTapChangerTable extends IdentifiedObject
{
	...
	public void updateAttributeInArray(RatioTapChangerTable_class_attributes_enum attrEnum, BaseClass value) {
		try {
	...
	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			...
			System.out.println("Updated RatioTapChangerTable, setting " + attrName);
		}
	...
	public void setAttribute(java.lang.String attrName, java.lang.String value) {
		try {
			...
			System.out.println("Updated RatioTapChangerTable, setting " + attrName  + " to: "  + value);
		}
		catch (IllegalArgumentException iae)
		{
			super.setAttribute(attrName, value);
