...
{
	private BaseClass[] Analog_attributes;
	...
	public Analog() {
		Analog_attributes = new BaseClass[Analog_primitive_builder.values().length];
	}

	public void updateAttributeInArray(Analog_primitive_builder attrEnum, BaseClass value) {
		try {
			Analog_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//Analog_ATTR_ENUM attrEnum = Analog_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (Analog_primitive_builder attrEnum: Analog_primitive_builder.values()) {
			BaseClass bc = Analog_attributes[attrEnum.ordinal()];
			if (bc != null) {
