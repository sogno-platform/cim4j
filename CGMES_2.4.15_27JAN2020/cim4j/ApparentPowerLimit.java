...
{
	private BaseClass[] ApparentPowerLimit_attributes;
	...
	public ApparentPowerLimit() {
		ApparentPowerLimit_attributes = new BaseClass[ApparentPowerLimit_primitive_builder.values().length];
	}

	public void updateAttributeInArray(ApparentPowerLimit_primitive_builder attrEnum, BaseClass value) {
		try {
			ApparentPowerLimit_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//ApparentPowerLimit_ATTR_ENUM attrEnum = ApparentPowerLimit_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (ApparentPowerLimit_primitive_builder attrEnum: ApparentPowerLimit_primitive_builder.values()) {
			BaseClass bc = ApparentPowerLimit_attributes[attrEnum.ordinal()];
			if (bc != null) {
