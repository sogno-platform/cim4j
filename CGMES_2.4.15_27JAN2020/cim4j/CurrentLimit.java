...
{
	private BaseClass[] CurrentLimit_attributes;
	...
	public CurrentLimit() {
		CurrentLimit_attributes = new BaseClass[CurrentLimit_primitive_builder.values().length];
	}

	public void updateAttributeInArray(CurrentLimit_primitive_builder attrEnum, BaseClass value) {
		try {
			CurrentLimit_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//CurrentLimit_ATTR_ENUM attrEnum = CurrentLimit_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (CurrentLimit_primitive_builder attrEnum: CurrentLimit_primitive_builder.values()) {
			BaseClass bc = CurrentLimit_attributes[attrEnum.ordinal()];
			if (bc != null) {
