...
{
	private BaseClass[] SvStatus_attributes;
	...
	public SvStatus() {
		SvStatus_attributes = new BaseClass[SvStatus_primitive_builder.values().length];
	}

	public void updateAttributeInArray(SvStatus_primitive_builder attrEnum, BaseClass value) {
		try {
			SvStatus_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//SvStatus_ATTR_ENUM attrEnum = SvStatus_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (SvStatus_primitive_builder attrEnum: SvStatus_primitive_builder.values()) {
			BaseClass bc = SvStatus_attributes[attrEnum.ordinal()];
			if (bc != null) {
