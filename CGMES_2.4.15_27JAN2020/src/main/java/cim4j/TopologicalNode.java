...
public class TopologicalNode extends IdentifiedObject {
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("AngleRefTopologicalIsland", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("BaseVoltage", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("ConnectivityNodeContainer", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            ...
            Map.entry("SvInjection", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("SvVoltage", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("Terminal", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("TopologicalIsland", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
            Map.entry("boundaryPoint", "http://entsoe.eu/CIM/SchemaExtension/3/1#"),
            Map.entry("fromEndIsoCode", "http://entsoe.eu/CIM/SchemaExtension/3/1#"),
            Map.entry("fromEndName", "http://entsoe.eu/CIM/SchemaExtension/3/1#"),
            Map.entry("fromEndNameTso", "http://entsoe.eu/CIM/SchemaExtension/3/1#"),
            Map.entry("toEndIsoCode", "http://entsoe.eu/CIM/SchemaExtension/3/1#"),
            Map.entry("toEndName", "http://entsoe.eu/CIM/SchemaExtension/3/1#"),
            Map.entry("toEndNameTso", "http://entsoe.eu/CIM/SchemaExtension/3/1#"),
