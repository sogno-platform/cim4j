...
{
	private BaseClass[] Season_attributes;
	...
	public Season() {
		Season_attributes = new BaseClass[Season_primitive_builder.values().length];
	}

	public void updateAttributeInArray(Season_primitive_builder attrEnum, BaseClass value) {
		try {
			Season_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//Season_ATTR_ENUM attrEnum = Season_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (Season_primitive_builder attrEnum: Season_primitive_builder.values()) {
			BaseClass bc = Season_attributes[attrEnum.ordinal()];
			if (bc != null) {
