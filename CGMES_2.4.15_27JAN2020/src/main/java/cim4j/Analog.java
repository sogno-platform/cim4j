...
public class Analog extends Measurement {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("AnalogValues", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("LimitSets", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("positiveFlowIn", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
