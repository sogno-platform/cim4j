...
{
	private BaseClass[] DiagramObjectStyle_attributes;
	...
	public DiagramObjectStyle() {
		DiagramObjectStyle_attributes = new BaseClass[DiagramObjectStyle_primitive_builder.values().length];
	}

	public void updateAttributeInArray(DiagramObjectStyle_primitive_builder attrEnum, BaseClass value) {
		try {
			DiagramObjectStyle_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//DiagramObjectStyle_ATTR_ENUM attrEnum = DiagramObjectStyle_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (DiagramObjectStyle_primitive_builder attrEnum: DiagramObjectStyle_primitive_builder.values()) {
			BaseClass bc = DiagramObjectStyle_attributes[attrEnum.ordinal()];
			if (bc != null) {
