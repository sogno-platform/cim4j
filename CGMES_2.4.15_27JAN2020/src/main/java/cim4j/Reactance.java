 ...
 */
public class Reactance extends BaseClass {

	private static final Logging LOG = Logging.getLogger(Reactance.class);
	...
	public Reactance(double v) {
		value = v;
		initialized = true;
	}

	public Reactance(java.lang.String s) {
		setValue(s);
	}
	...
	private final java.lang.String debugName = "Reactance";
