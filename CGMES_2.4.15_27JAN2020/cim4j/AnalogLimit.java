...
{
	private BaseClass[] AnalogLimit_attributes;
	...
	public AnalogLimit() {
		AnalogLimit_attributes = new BaseClass[AnalogLimit_primitive_builder.values().length];
	}

	public void updateAttributeInArray(AnalogLimit_primitive_builder attrEnum, BaseClass value) {
		try {
			AnalogLimit_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//AnalogLimit_ATTR_ENUM attrEnum = AnalogLimit_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (AnalogLimit_primitive_builder attrEnum: AnalogLimit_primitive_builder.values()) {
			BaseClass bc = AnalogLimit_attributes[attrEnum.ordinal()];
			if (bc != null) {
