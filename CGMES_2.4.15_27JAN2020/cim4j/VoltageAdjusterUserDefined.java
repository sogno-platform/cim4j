...
{
	private BaseClass[] VoltageAdjusterUserDefined_attributes;
	...
	public VoltageAdjusterUserDefined() {
		VoltageAdjusterUserDefined_attributes = new BaseClass[VoltageAdjusterUserDefined_primitive_builder.values().length];
	}

	public void updateAttributeInArray(VoltageAdjusterUserDefined_primitive_builder attrEnum, BaseClass value) {
		try {
			VoltageAdjusterUserDefined_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//VoltageAdjusterUserDefined_ATTR_ENUM attrEnum = VoltageAdjusterUserDefined_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (VoltageAdjusterUserDefined_primitive_builder attrEnum: VoltageAdjusterUserDefined_primitive_builder.values()) {
			BaseClass bc = VoltageAdjusterUserDefined_attributes[attrEnum.ordinal()];
			if (bc != null) {
