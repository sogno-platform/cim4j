...
{
	private BaseClass[] WindGenTurbineType3bIEC_attributes;
	...
	public WindGenTurbineType3bIEC() {
		WindGenTurbineType3bIEC_attributes = new BaseClass[WindGenTurbineType3bIEC_primitive_builder.values().length];
	}

	public void updateAttributeInArray(WindGenTurbineType3bIEC_primitive_builder attrEnum, BaseClass value) {
		try {
			WindGenTurbineType3bIEC_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//WindGenTurbineType3bIEC_ATTR_ENUM attrEnum = WindGenTurbineType3bIEC_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (WindGenTurbineType3bIEC_primitive_builder attrEnum: WindGenTurbineType3bIEC_primitive_builder.values()) {
			BaseClass bc = WindGenTurbineType3bIEC_attributes[attrEnum.ordinal()];
			if (bc != null) {
