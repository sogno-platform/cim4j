...
{
	private BaseClass[] Bay_attributes;
	...
	public Bay() {
		Bay_attributes = new BaseClass[Bay_primitive_builder.values().length];
	}

	public void updateAttributeInArray(Bay_primitive_builder attrEnum, BaseClass value) {
		try {
			Bay_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//Bay_ATTR_ENUM attrEnum = Bay_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (Bay_primitive_builder attrEnum: Bay_primitive_builder.values()) {
			BaseClass bc = Bay_attributes[attrEnum.ordinal()];
			if (bc != null) {
