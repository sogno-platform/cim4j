...
{
	private BaseClass[] ExcDC1A_attributes;
	...
	public ExcDC1A() {
		ExcDC1A_attributes = new BaseClass[ExcDC1A_primitive_builder.values().length];
	}

	public void updateAttributeInArray(ExcDC1A_primitive_builder attrEnum, BaseClass value) {
		try {
			ExcDC1A_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//ExcDC1A_ATTR_ENUM attrEnum = ExcDC1A_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (ExcDC1A_primitive_builder attrEnum: ExcDC1A_primitive_builder.values()) {
			BaseClass bc = ExcDC1A_attributes[attrEnum.ordinal()];
			if (bc != null) {
