...
public class WindGenTurbineType3IEC extends WindTurbineType3or4IEC
{
	...
	public void updateAttributeInArray(WindGenTurbineType3IEC_class_attributes_enum attrEnum, BaseClass value) {
		try {
	...
	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			...
			System.out.println("Updated WindGenTurbineType3IEC, setting " + attrName);
		}
	...
	public void setAttribute(java.lang.String attrName, java.lang.String value) {
		try {
			...
			System.out.println("Updated WindGenTurbineType3IEC, setting " + attrName  + " to: "  + value);
		}
		catch (IllegalArgumentException iae)
		{
			super.setAttribute(attrName, value);
