...
public class WindGenTurbineType1IEC extends WindTurbineType1or2IEC {
    ...
    static {
        ATTRIBUTE_NAMES_MAP = new WindGenTurbineType1IEC().getAttributeNamesMap();
    }
    ...
    private void updateAttributeInArray(WindGenTurbineType1IEC_class_attributes_enum attrEnum, BaseClass value) {
        try {
    ...
    private void updateAttributeInArray(WindGenTurbineType1IEC_primitive_builder attrEnum, BaseClass value) {
        try {
    ...
    public void setAttribute(java.lang.String attrName, BaseClass value) {
        try {
            ...
            LOG.debug("Updated WindGenTurbineType1IEC, setting " + attrName);
    ...
    public void setAttribute(java.lang.String attrName, java.lang.String value) {
        try {
            ...
            LOG.debug("Updated WindGenTurbineType1IEC, setting " + attrName + " to: " + value);
        } catch (IllegalArgumentException iae) {
            super.setAttribute(attrName, value);
        }
    }
    ...
    public BaseClass getAttribute(java.lang.String attrName) {
        ...
        try {
            WindGenTurbineType1IEC_primitive_builder attrEnum = WindGenTurbineType1IEC_primitive_builder.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindGenTurbineType1IEC_primitive_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        ...
        try {
            WindGenTurbineType1IEC_class_attributes_enum attrEnum = WindGenTurbineType1IEC_class_attributes_enum.valueOf(attrName);
            defined = true;
            BaseClass attrValue = WindGenTurbineType1IEC_class_attributes[attrEnum.ordinal()];
            if (attrValue != null) {
                return attrValue;
            }
        } catch (IllegalArgumentException ignored) {
    ...
    protected Map<java.lang.String, java.lang.String> getAttributeNamesMap() {
        ...
        for (var enumValue : WindGenTurbineType1IEC_primitive_builder.values()) {
            if (enumValue != WindGenTurbineType1IEC_primitive_builder.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindGenTurbineType1IEC." + enumValue.name());
            }
        }
        for (var enumValue : WindGenTurbineType1IEC_class_attributes_enum.values()) {
            if (enumValue != WindGenTurbineType1IEC_class_attributes_enum.LAST_ENUM) {
                namesMap.put(enumValue.name(), "WindGenTurbineType1IEC." + enumValue.name());
            }
        }
    ...
    private final java.lang.String debugName = "WindGenTurbineType1IEC";
    ...
    static {
        ATTR_NAMESPACE_MAP = new WindGenTurbineType1IEC().allAttrNamespaceMap();
    }
    ...
    private Map<java.lang.String, java.lang.String> classAttrNamespaceMap = Map.ofEntries(
            Map.entry("WindAeroConstIEC", "http://iec.ch/TC57/2013/CIM-schema-cim16#"),
