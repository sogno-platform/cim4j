...
{
	private BaseClass[] TapSchedule_attributes;
	...
	public TapSchedule() {
		TapSchedule_attributes = new BaseClass[TapSchedule_primitive_builder.values().length];
	}

	public void updateAttributeInArray(TapSchedule_primitive_builder attrEnum, BaseClass value) {
		try {
			TapSchedule_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//TapSchedule_ATTR_ENUM attrEnum = TapSchedule_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (TapSchedule_primitive_builder attrEnum: TapSchedule_primitive_builder.values()) {
			BaseClass bc = TapSchedule_attributes[attrEnum.ordinal()];
			if (bc != null) {
