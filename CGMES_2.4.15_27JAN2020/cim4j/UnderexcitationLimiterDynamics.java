...
{
	private BaseClass[] UnderexcitationLimiterDynamics_attributes;
	...
	public UnderexcitationLimiterDynamics() {
		UnderexcitationLimiterDynamics_attributes = new BaseClass[UnderexcitationLimiterDynamics_primitive_builder.values().length];
	}

	public void updateAttributeInArray(UnderexcitationLimiterDynamics_primitive_builder attrEnum, BaseClass value) {
		try {
			UnderexcitationLimiterDynamics_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//UnderexcitationLimiterDynamics_ATTR_ENUM attrEnum = UnderexcitationLimiterDynamics_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (UnderexcitationLimiterDynamics_primitive_builder attrEnum: UnderexcitationLimiterDynamics_primitive_builder.values()) {
			BaseClass bc = UnderexcitationLimiterDynamics_attributes[attrEnum.ordinal()];
			if (bc != null) {
