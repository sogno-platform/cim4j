...
public class WindGeneratingUnit extends GeneratingUnit {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("WindPowerPlant", new AttrDetails("http://iec.ch/TC57/CIM100-European#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("windGenUnitType", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
