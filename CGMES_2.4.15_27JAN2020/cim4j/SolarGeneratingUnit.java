...
{
	private BaseClass[] SolarGeneratingUnit_attributes;
	...
	public SolarGeneratingUnit() {
		SolarGeneratingUnit_attributes = new BaseClass[SolarGeneratingUnit_primitive_builder.values().length];
	}

	public void updateAttributeInArray(SolarGeneratingUnit_primitive_builder attrEnum, BaseClass value) {
		try {
			SolarGeneratingUnit_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//SolarGeneratingUnit_ATTR_ENUM attrEnum = SolarGeneratingUnit_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (SolarGeneratingUnit_primitive_builder attrEnum: SolarGeneratingUnit_primitive_builder.values()) {
			BaseClass bc = SolarGeneratingUnit_attributes[attrEnum.ordinal()];
			if (bc != null) {
