...
{
	private BaseClass[] GeographicalRegion_attributes;
	...
	public GeographicalRegion() {
		GeographicalRegion_attributes = new BaseClass[GeographicalRegion_primitive_builder.values().length];
	}

	public void updateAttributeInArray(GeographicalRegion_primitive_builder attrEnum, BaseClass value) {
		try {
			GeographicalRegion_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//GeographicalRegion_ATTR_ENUM attrEnum = GeographicalRegion_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (GeographicalRegion_primitive_builder attrEnum: GeographicalRegion_primitive_builder.values()) {
			BaseClass bc = GeographicalRegion_attributes[attrEnum.ordinal()];
			if (bc != null) {
