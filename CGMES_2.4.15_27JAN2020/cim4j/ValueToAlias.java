...
{
	private BaseClass[] ValueToAlias_attributes;
	...
	public ValueToAlias() {
		ValueToAlias_attributes = new BaseClass[ValueToAlias_primitive_builder.values().length];
	}

	public void updateAttributeInArray(ValueToAlias_primitive_builder attrEnum, BaseClass value) {
		try {
			ValueToAlias_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//ValueToAlias_ATTR_ENUM attrEnum = ValueToAlias_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (ValueToAlias_primitive_builder attrEnum: ValueToAlias_primitive_builder.values()) {
			BaseClass bc = ValueToAlias_attributes[attrEnum.ordinal()];
			if (bc != null) {
