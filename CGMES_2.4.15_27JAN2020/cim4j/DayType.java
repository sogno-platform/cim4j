...
{
	private BaseClass[] DayType_attributes;
	...
	public DayType() {
		DayType_attributes = new BaseClass[DayType_primitive_builder.values().length];
	}

	public void updateAttributeInArray(DayType_primitive_builder attrEnum, BaseClass value) {
		try {
			DayType_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//DayType_ATTR_ENUM attrEnum = DayType_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (DayType_primitive_builder attrEnum: DayType_primitive_builder.values()) {
			BaseClass bc = DayType_attributes[attrEnum.ordinal()];
			if (bc != null) {
