...
{
	private BaseClass[] OperationalLimitSet_attributes;
	...
	public OperationalLimitSet() {
		OperationalLimitSet_attributes = new BaseClass[OperationalLimitSet_primitive_builder.values().length];
	}

	public void updateAttributeInArray(OperationalLimitSet_primitive_builder attrEnum, BaseClass value) {
		try {
			OperationalLimitSet_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//OperationalLimitSet_ATTR_ENUM attrEnum = OperationalLimitSet_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (OperationalLimitSet_primitive_builder attrEnum: OperationalLimitSet_primitive_builder.values()) {
			BaseClass bc = OperationalLimitSet_attributes[attrEnum.ordinal()];
			if (bc != null) {
