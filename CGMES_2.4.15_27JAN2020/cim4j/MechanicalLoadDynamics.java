...
{
	private BaseClass[] MechanicalLoadDynamics_attributes;
	...
	public MechanicalLoadDynamics() {
		MechanicalLoadDynamics_attributes = new BaseClass[MechanicalLoadDynamics_primitive_builder.values().length];
	}

	public void updateAttributeInArray(MechanicalLoadDynamics_primitive_builder attrEnum, BaseClass value) {
		try {
			MechanicalLoadDynamics_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//MechanicalLoadDynamics_ATTR_ENUM attrEnum = MechanicalLoadDynamics_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (MechanicalLoadDynamics_primitive_builder attrEnum: MechanicalLoadDynamics_primitive_builder.values()) {
			BaseClass bc = MechanicalLoadDynamics_attributes[attrEnum.ordinal()];
			if (bc != null) {
