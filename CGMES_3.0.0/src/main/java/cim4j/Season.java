...
public class Season extends IdentifiedObject {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("SeasonDayTypeSchedules", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("endDate", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("startDate", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
