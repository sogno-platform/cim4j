...
{
	private BaseClass[] WindTurbineType3or4Dynamics_attributes;
	...
	public WindTurbineType3or4Dynamics() {
		WindTurbineType3or4Dynamics_attributes = new BaseClass[WindTurbineType3or4Dynamics_primitive_builder.values().length];
	}

	public void updateAttributeInArray(WindTurbineType3or4Dynamics_primitive_builder attrEnum, BaseClass value) {
		try {
			WindTurbineType3or4Dynamics_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//WindTurbineType3or4Dynamics_ATTR_ENUM attrEnum = WindTurbineType3or4Dynamics_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (WindTurbineType3or4Dynamics_primitive_builder attrEnum: WindTurbineType3or4Dynamics_primitive_builder.values()) {
			BaseClass bc = WindTurbineType3or4Dynamics_attributes[attrEnum.ordinal()];
			if (bc != null) {
