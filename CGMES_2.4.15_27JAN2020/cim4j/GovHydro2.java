...
{
	private BaseClass[] GovHydro2_attributes;
	...
	public GovHydro2() {
		GovHydro2_attributes = new BaseClass[GovHydro2_primitive_builder.values().length];
	}

	public void updateAttributeInArray(GovHydro2_primitive_builder attrEnum, BaseClass value) {
		try {
			GovHydro2_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//GovHydro2_ATTR_ENUM attrEnum = GovHydro2_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (GovHydro2_primitive_builder attrEnum: GovHydro2_primitive_builder.values()) {
			BaseClass bc = GovHydro2_attributes[attrEnum.ordinal()];
			if (bc != null) {
