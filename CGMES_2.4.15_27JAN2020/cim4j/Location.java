...
{
	private BaseClass[] Location_attributes;
	...
	public Location() {
		Location_attributes = new BaseClass[Location_primitive_builder.values().length];
	}

	public void updateAttributeInArray(Location_primitive_builder attrEnum, BaseClass value) {
		try {
			Location_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//Location_ATTR_ENUM attrEnum = Location_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (Location_primitive_builder attrEnum: Location_primitive_builder.values()) {
			BaseClass bc = Location_attributes[attrEnum.ordinal()];
			if (bc != null) {
