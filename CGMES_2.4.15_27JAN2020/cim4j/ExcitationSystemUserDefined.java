...
{
	private BaseClass[] ExcitationSystemUserDefined_attributes;
	...
	public ExcitationSystemUserDefined() {
		ExcitationSystemUserDefined_attributes = new BaseClass[ExcitationSystemUserDefined_primitive_builder.values().length];
	}

	public void updateAttributeInArray(ExcitationSystemUserDefined_primitive_builder attrEnum, BaseClass value) {
		try {
			ExcitationSystemUserDefined_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//ExcitationSystemUserDefined_ATTR_ENUM attrEnum = ExcitationSystemUserDefined_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (ExcitationSystemUserDefined_primitive_builder attrEnum: ExcitationSystemUserDefined_primitive_builder.values()) {
			BaseClass bc = ExcitationSystemUserDefined_attributes[attrEnum.ordinal()];
			if (bc != null) {
