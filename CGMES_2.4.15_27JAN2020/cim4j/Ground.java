...
{
	private BaseClass[] Ground_attributes;
	...
	public Ground() {
		Ground_attributes = new BaseClass[Ground_primitive_builder.values().length];
	}

	public void updateAttributeInArray(Ground_primitive_builder attrEnum, BaseClass value) {
		try {
			Ground_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//Ground_ATTR_ENUM attrEnum = Ground_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (Ground_primitive_builder attrEnum: Ground_primitive_builder.values()) {
			BaseClass bc = Ground_attributes[attrEnum.ordinal()];
			if (bc != null) {
