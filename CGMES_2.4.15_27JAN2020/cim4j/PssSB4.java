...
{
	private BaseClass[] PssSB4_attributes;
	...
	public PssSB4() {
		PssSB4_attributes = new BaseClass[PssSB4_primitive_builder.values().length];
	}

	public void updateAttributeInArray(PssSB4_primitive_builder attrEnum, BaseClass value) {
		try {
			PssSB4_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//PssSB4_ATTR_ENUM attrEnum = PssSB4_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (PssSB4_primitive_builder attrEnum: PssSB4_primitive_builder.values()) {
			BaseClass bc = PssSB4_attributes[attrEnum.ordinal()];
			if (bc != null) {
