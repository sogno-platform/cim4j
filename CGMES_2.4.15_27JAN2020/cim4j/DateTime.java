...
{
	private BaseClass[] DateTime_attributes;
	...
	public DateTime() {
		DateTime_attributes = new BaseClass[DateTime_primitive_builder.values().length];
	}

	public void updateAttributeInArray(DateTime_primitive_builder attrEnum, BaseClass value) {
		try {
			DateTime_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//DateTime_ATTR_ENUM attrEnum = DateTime_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (DateTime_primitive_builder attrEnum: DateTime_primitive_builder.values()) {
			BaseClass bc = DateTime_attributes[attrEnum.ordinal()];
			if (bc != null) {
