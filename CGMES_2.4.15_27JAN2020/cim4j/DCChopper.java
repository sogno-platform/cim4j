...
{
	private BaseClass[] DCChopper_attributes;
	...
	public DCChopper() {
		DCChopper_attributes = new BaseClass[DCChopper_primitive_builder.values().length];
	}

	public void updateAttributeInArray(DCChopper_primitive_builder attrEnum, BaseClass value) {
		try {
			DCChopper_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//DCChopper_ATTR_ENUM attrEnum = DCChopper_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (DCChopper_primitive_builder attrEnum: DCChopper_primitive_builder.values()) {
			BaseClass bc = DCChopper_attributes[attrEnum.ordinal()];
			if (bc != null) {
