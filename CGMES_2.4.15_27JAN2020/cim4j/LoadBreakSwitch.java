...
{
	private BaseClass[] LoadBreakSwitch_attributes;
	...
	public LoadBreakSwitch() {
		LoadBreakSwitch_attributes = new BaseClass[LoadBreakSwitch_primitive_builder.values().length];
	}

	public void updateAttributeInArray(LoadBreakSwitch_primitive_builder attrEnum, BaseClass value) {
		try {
			LoadBreakSwitch_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//LoadBreakSwitch_ATTR_ENUM attrEnum = LoadBreakSwitch_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (LoadBreakSwitch_primitive_builder attrEnum: LoadBreakSwitch_primitive_builder.values()) {
			BaseClass bc = LoadBreakSwitch_attributes[attrEnum.ordinal()];
			if (bc != null) {
