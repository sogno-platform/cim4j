...
public class ReactiveCapabilityCurve extends Curve {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("EquivalentInjection", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.EQ);
            map.put("InitiallyUsedBySynchronousMachines", new AttrDetails("http://iec.ch/TC57/CIM100#", profiles));
        }
