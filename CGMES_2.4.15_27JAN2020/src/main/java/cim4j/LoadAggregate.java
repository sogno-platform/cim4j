...
public class LoadAggregate extends LoadDynamics {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("LoadMotor", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.DY);
            map.put("LoadStatic", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
