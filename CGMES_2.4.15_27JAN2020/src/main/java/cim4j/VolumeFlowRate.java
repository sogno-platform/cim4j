...
public class VolumeFlowRate extends BaseClass {
	...
	private static final Logging LOG = Logging.getLogger(VolumeFlowRate.class);
	...
	public VolumeFlowRate(java.lang.String s) {
		setValue(s);
	}
	...
	private final java.lang.String debugName = "VolumeFlowRate";
