...
public class TopologicalIsland extends IdentifiedObject {
    ...
    static {
        Map<java.lang.String, AttrDetails> map = new LinkedHashMap<>();
        {
            ...
            map.put("AngleRefTopologicalNode", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
        {
            Set<CGMESProfile> profiles = new LinkedHashSet<>();
            profiles.add(CGMESProfile.SV);
            map.put("TopologicalNodes", new AttrDetails("http://iec.ch/TC57/2013/CIM-schema-cim16#", profiles));
        }
