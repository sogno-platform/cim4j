...
public class ResistancePerLength extends BaseClass {
    ...
    private static final Logging LOG = Logging.getLogger(ResistancePerLength.class);
    ...
    public ResistancePerLength(double v) {
        value = v;
        initialized = true;
    }

    public ResistancePerLength(java.lang.String s) {
        setValue(s);
    }
    ...
    private final java.lang.String debugName = "ResistancePerLength";
