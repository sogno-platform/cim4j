...
{
	private BaseClass[] PowerSystemStabilizerUserDefined_attributes;
	...
	public PowerSystemStabilizerUserDefined() {
		PowerSystemStabilizerUserDefined_attributes = new BaseClass[PowerSystemStabilizerUserDefined_primitive_builder.values().length];
	}

	public void updateAttributeInArray(PowerSystemStabilizerUserDefined_primitive_builder attrEnum, BaseClass value) {
		try {
			PowerSystemStabilizerUserDefined_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//PowerSystemStabilizerUserDefined_ATTR_ENUM attrEnum = PowerSystemStabilizerUserDefined_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (PowerSystemStabilizerUserDefined_primitive_builder attrEnum: PowerSystemStabilizerUserDefined_primitive_builder.values()) {
			BaseClass bc = PowerSystemStabilizerUserDefined_attributes[attrEnum.ordinal()];
			if (bc != null) {
