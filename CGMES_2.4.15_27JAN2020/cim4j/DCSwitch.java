...
{
	private BaseClass[] DCSwitch_attributes;
	...
	public DCSwitch() {
		DCSwitch_attributes = new BaseClass[DCSwitch_primitive_builder.values().length];
	}

	public void updateAttributeInArray(DCSwitch_primitive_builder attrEnum, BaseClass value) {
		try {
			DCSwitch_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//DCSwitch_ATTR_ENUM attrEnum = DCSwitch_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (DCSwitch_primitive_builder attrEnum: DCSwitch_primitive_builder.values()) {
			BaseClass bc = DCSwitch_attributes[attrEnum.ordinal()];
			if (bc != null) {
