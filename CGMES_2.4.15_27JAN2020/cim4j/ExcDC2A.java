...
{
	private BaseClass[] ExcDC2A_attributes;
	...
	public ExcDC2A() {
		ExcDC2A_attributes = new BaseClass[ExcDC2A_primitive_builder.values().length];
	}

	public void updateAttributeInArray(ExcDC2A_primitive_builder attrEnum, BaseClass value) {
		try {
			ExcDC2A_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//ExcDC2A_ATTR_ENUM attrEnum = ExcDC2A_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (ExcDC2A_primitive_builder attrEnum: ExcDC2A_primitive_builder.values()) {
			BaseClass bc = ExcDC2A_attributes[attrEnum.ordinal()];
			if (bc != null) {
