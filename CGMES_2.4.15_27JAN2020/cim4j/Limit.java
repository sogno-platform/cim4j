...
{
	private BaseClass[] Limit_attributes;
	...
	public Limit() {
		Limit_attributes = new BaseClass[Limit_primitive_builder.values().length];
	}

	public void updateAttributeInArray(Limit_primitive_builder attrEnum, BaseClass value) {
		try {
			Limit_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//Limit_ATTR_ENUM attrEnum = Limit_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (Limit_primitive_builder attrEnum: Limit_primitive_builder.values()) {
			BaseClass bc = Limit_attributes[attrEnum.ordinal()];
			if (bc != null) {
