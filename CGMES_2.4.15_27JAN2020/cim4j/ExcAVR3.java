...
{
	private BaseClass[] ExcAVR3_attributes;
	...
	public ExcAVR3() {
		ExcAVR3_attributes = new BaseClass[ExcAVR3_primitive_builder.values().length];
	}

	public void updateAttributeInArray(ExcAVR3_primitive_builder attrEnum, BaseClass value) {
		try {
			ExcAVR3_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//ExcAVR3_ATTR_ENUM attrEnum = ExcAVR3_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (ExcAVR3_primitive_builder attrEnum: ExcAVR3_primitive_builder.values()) {
			BaseClass bc = ExcAVR3_attributes[attrEnum.ordinal()];
			if (bc != null) {
