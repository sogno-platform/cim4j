...
{
	private BaseClass[] AsynchronousMachineUserDefined_attributes;
	...
	public AsynchronousMachineUserDefined() {
		AsynchronousMachineUserDefined_attributes = new BaseClass[AsynchronousMachineUserDefined_primitive_builder.values().length];
	}

	public void updateAttributeInArray(AsynchronousMachineUserDefined_primitive_builder attrEnum, BaseClass value) {
		try {
			AsynchronousMachineUserDefined_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//AsynchronousMachineUserDefined_ATTR_ENUM attrEnum = AsynchronousMachineUserDefined_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (AsynchronousMachineUserDefined_primitive_builder attrEnum: AsynchronousMachineUserDefined_primitive_builder.values()) {
			BaseClass bc = AsynchronousMachineUserDefined_attributes[attrEnum.ordinal()];
			if (bc != null) {
