...
{
	private BaseClass[] StationSupply_attributes;
	...
	public StationSupply() {
		StationSupply_attributes = new BaseClass[StationSupply_primitive_builder.values().length];
	}

	public void updateAttributeInArray(StationSupply_primitive_builder attrEnum, BaseClass value) {
		try {
			StationSupply_attributes[attrEnum.ordinal()] = value;
		}
 	...
 	public void setAttribute(java.lang.String attrName, BaseClass value) {
		try {
			//StationSupply_ATTR_ENUM attrEnum = StationSupply_ATTR_BC_ENUM.valueOf(attrName);
		}
	...
	public java.lang.String toString() {
		...
		for (StationSupply_primitive_builder attrEnum: StationSupply_primitive_builder.values()) {
			BaseClass bc = StationSupply_attributes[attrEnum.ordinal()];
			if (bc != null) {
